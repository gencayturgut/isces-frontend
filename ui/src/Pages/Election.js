...
function Election() {
  ...
  const fetchTiedCandidates = async () => {
    try {
      const response = await axios.get("https://iztechelection.herokuapp.com/tiedDelegates");
  ...
  const fetchCandidateInfo = async () => {
    try {
      let url = `https://iztechelection.herokuapp.com/candidates/allPreviousElectionCandidates/${selectedDepartment}`;
  ...
  const concludeElection = () => {
    ...
    const handleConcludeTie = async (department) => {
      ...
      try {
        const url = `https://iztechelection.herokuapp.com/concludeTie/${selectedCandidateId}`;
